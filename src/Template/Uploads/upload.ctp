...
//              document.getElementById('date').value = today;
        ...
        <div class="dropdown">
            ...
            <form method="post">
                ...
                <input type="text" name="Category" style="width: 250px; float: left; margin-top: 30px" placeholder="Enter a Category" />
                <br><input type="number" name="Price" step="0.01" style="width: 250px; float: right; height: 40px" placeholder="Enter your price" /></br>
                <br><br><b><font size="5">Title</font></b></br></br>
                <input type="text" name="Title" placeholder="Enter a Title" style="float: right; clear: both"/>
                ...
                <input type="submit" value="Submit" style="float: right" onsubmit="UploadSuccessful">
